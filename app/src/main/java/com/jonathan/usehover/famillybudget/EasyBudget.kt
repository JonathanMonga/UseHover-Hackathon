...
package com.jonathan.usehover.famillybudget
...
import com.jonathan.usehover.famillybudget.BuildVersion.VERSION_2_1_0
import com.jonathan.usehover.famillybudget.BuildVersion.VERSION_2_1_3
...
import com.jonathan.usehover.famillybudget.injection.appModule
import com.jonathan.usehover.famillybudget.injection.viewModelModule
import com.jonathan.usehover.famillybudget.notif.*
import com.jonathan.usehover.famillybudget.parameters.*
import com.jonathan.usehover.famillybudget.push.PushService.Companion.DAILY_REMINDER_KEY
import com.jonathan.usehover.famillybudget.push.PushService.Companion.MONTHLY_REMINDER_KEY
import com.jonathan.usehover.famillybudget.view.main.MainActivity
import com.jonathan.usehover.famillybudget.view.RatingPopup
import com.jonathan.usehover.famillybudget.view.settings.SettingsActivity
import com.jonathan.usehover.famillybudget.view.getRatingPopupUserStep
...
/**
 * FamillyBudget application. Implements GA tracking, Batch set-up, Crashlytics set-up && iab.
 *
 * @author Jonathan MONGA
 */
class FamillyBudget : Application() {
...
// ------------------------------------------>
    ...
    override fun onCreate() {
        ...
        startKoin {
            androidLogger()
            androidContext(this@FamillyBudget)
